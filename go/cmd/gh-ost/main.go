...
func main() {
	...
	throttleHTTPIntervalMillis := flag.Int64("throttle-http-interval-millis", 100, "Number of milliseconds to wait between HTTP throttle checks. This is also used as the HTTP request timeout")
