...
func main() {
	...
	flag.BoolVar(&migrationContext.SkipStrictTransTables, "skip-strict-trans-tables", false, "explicitly tell gh-ost binlog applier not to enforce STRICT_TRANS_TABLES in sql_mode")
