...
func main() {
	...
	flag.BoolVar(&migrationContext.SkipMetadataLockChecks, "skip-metadata-lock-checks", false, "Skip metadata lock checks at cut-over time. The checks require performance_schema.metadata_lock to be enabled")
