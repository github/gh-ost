...
func BuildUniqueKeyMinValuesPreparedQuery(databaseName, tableName string, whereStmt string, uniqueKeyColumns *ColumnList, forceOnMaster, runningOnMaster bool) (string, error) {
